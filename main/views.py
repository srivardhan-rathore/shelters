...
class HotelServiceViewM(TemplateView):
    ...
    def post(self, request):
        ...
        messages.success(request,
                         'Your request for Hotel Booking has been placed successfully. You will receive a '
...
class HotelServiceView(TemplateView):
    ...
    def post(self, request):
        ...
        booking.client = self.request.user
        booking.save()
        messages.success(request, "Your request for Hotel Booking has been placed successfully. You will receive a "
                                  "confirmation email shortly.")
        return redirect("main:hotel")
...
class TaxiServiceView(TemplateView):
    ...
    def post(self, request):
        ...
        booking.client = self.request.user
        booking.save()
        messages.success(request, "Your request for Airport taxi has been placed successfully. You will receive a "
                                  "confirmation email shortly.")
        return redirect("main:taxi")
...
class AccommodationServiceViewM(TemplateView):
    ...
    def post(self, request):
        ...
        booking.save()
        messages.success(request,
                         "Your request for Accommodation has been placed successfully. You will receive a "
                         "confirmation email shortly.")
        return redirect("main:accommodation_m")
